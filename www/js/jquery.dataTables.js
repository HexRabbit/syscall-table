...
(function($) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			/* Custom modification for scrolling table */
			var parent = oSettings.nTable.parentNode;
			var wrapper = document.createElement('div');
			wrapper.setAttribute('style', 'overflow: scroll;');

			parent.replaceChild(wrapper, oSettings.nTable);
			wrapper.appendChild(oSettings.nTable);
		}
